/* USF file - DO NOT MODIFY THIS FILE. THIS FILE IS REGULARLY CHANGED BY USF APP AND **ANY DIRECT CHANGES WILL BE LOST**. Use our in-app customization if you need to update CSS and JS code. Auto modified at: 11/19/2023 1:22:59 AM*/
...
`<div class="usf-is-product usf-clear" @click="onItemClick">
    ...
    <div class="usf-pull-left" @click="window.location = usf.platform.getProductUrl(null, product)">
        <!-- Title -->
