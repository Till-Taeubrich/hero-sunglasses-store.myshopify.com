...
// Assuming details is an object with a property named open
if (details && details.open === true) {
  // Assuming variant-details is a property of details
  var variantDetails = details.variant-details;

  // Assuming section-header is the element you want to manipulate
  var sectionHeader = document.querySelector('.section-header');

  // Checking if variantDetails is truthy to ensure it exists
  if (variantDetails && sectionHeader) {
    // Setting the z-index to 0
    sectionHeader.style.zIndex = 0;
  }
}
